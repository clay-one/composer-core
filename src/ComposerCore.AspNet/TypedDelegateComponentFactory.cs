...
{
	public class TypedDelegateComponentFactory<TComponent> : IComponentFactory where TComponent : class
	{
		...
		public TypedDelegateComponentFactory(Func<IComposer, TComponent> factoryMethod)
		{
