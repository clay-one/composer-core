...
namespace ComposerCore.Tests.XmlValueParser
{
	...
	public class SingleTest
	{
		...
		{
			_context.ProcessCompositionXmlFromResource("ComposerCore.Tests.XmlValueParser.Xmls.ASingle.xml");
		...
		{
			_context.ProcessCompositionXmlFromResource("ComposerCore.Tests.XmlValueParser.Xmls.ESingle.xml");
